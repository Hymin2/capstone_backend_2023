...
public enum ProductFilterDetail {
    ...
    PROCESSOR_EQ_SNAPDRAGON_8_GEN_1("1019", ProductFilter.PROCESSOR_EQ.getQuery("스냅드래곤8%Gen1%", null)),
    PROCESSOR_EQ_SNAPDRAGON_8XX    ("1020", ProductFilter.PROCESSOR_EQ.getQuery("스냅드래곤8%", null).and(QDetail.detail.detailContent.notLike("%Gen%"))),
    PROCESSOR_EQ_SNAPDRAGON_7XX    ("1021", ProductFilter.PROCESSOR_EQ.getQuery("스냅드래곤7%", null)),
    PROCESSOR_EQ_SNAPDRAGON_6XX    ("1022", ProductFilter.PROCESSOR_EQ.getQuery("스냅드래곤6%", null)),
    PROCESSOR_EQ_A16               ("1023", ProductFilter.PROCESSOR_EQ.getQuery("A16%", null)),
    PROCESSOR_EQ_A15               ("1024", ProductFilter.PROCESSOR_EQ.getQuery("A15%", null)),
    PROCESSOR_EQ_A14               ("1025", ProductFilter.PROCESSOR_EQ.getQuery("A14%", null)),
    PROCESSOR_EQ_A13               ("1026", ProductFilter.PROCESSOR_EQ.getQuery("A13%", null)),
    PROCESSOR_EQ_DIMENSITY         ("1027", ProductFilter.PROCESSOR_EQ.getQuery("디맨시티%", null)),
    PROCESSOR_EQ_EXYNOS            ("1028", ProductFilter.PROCESSOR_EQ.getQuery("엑시노스%", null)),
    PROCESSOR_EQ_HELIO             ("1029", ProductFilter.PROCESSOR_EQ.getQuery("Helio%", null)),
    PROCESSOR_EQ_MEDIATEK          ("1030", ProductFilter.PROCESSOR_EQ.getQuery("미디어텍%", null)),

    RAM_EQ_2GB ("1031", ProductFilter.RAM_EQ.getQuery("2GB", null)),
    RAM_EQ_3GB ("1032", ProductFilter.RAM_EQ.getQuery("3GB", null)),
    RAM_EQ_4GB ("1033", ProductFilter.RAM_EQ.getQuery("4GB", null)),
    RAM_EQ_6GB ("1034", ProductFilter.RAM_EQ.getQuery("6GB", null)),
    RAM_EQ_8GB ("1035", ProductFilter.RAM_EQ.getQuery("8GB", null)),
    RAM_EQ_12GB("1036", ProductFilter.RAM_EQ.getQuery("12GB", null)),
    RAM_EQ_16GB("1037", ProductFilter.RAM_EQ.getQuery("16GB", null)),

    MEMORY_EQ_32GB ("1038", ProductFilter.MEMORY_EQ.getQuery("32GB", null)),
    MEMORY_EQ_64GB ("1039", ProductFilter.MEMORY_EQ.getQuery("64GB", null)),
    MEMORY_EQ_128GB("1040", ProductFilter.MEMORY_EQ.getQuery("128GB", null)),
    MEMORY_EQ_256GB("1041", ProductFilter.MEMORY_EQ.getQuery("256GB", null)),
    MEMORY_EQ_512GB("1042", ProductFilter.MEMORY_EQ.getQuery("512GB", null)),
    MEMORY_EQ_1TB  ("1043", ProductFilter.MEMORY_EQ.getQuery("1TB", null));
    private String code;
