...
public class UserServiceTest {
    ...
    void successRegister(){
        ...
        User user2 = userRepository.findByUsername("유저ID1").get();
    ...
    void saveEncodedPassword(){
        ...
        User user = userRepository.findByUsername("유저ID2").get();
    ...
    void checkDuplicateId(){
        ...
        userService.registerUser(userRegisterDto);
        User user = userRepository.findByUsername("유저ID3").get();
    ...
    void checkNoDuplicateId(){
        ...
        userService.registerUser(userRegisterDto);
        User user = userRepository.findByUsername("유저ID4").get();
    ...
    void checkDuplicateNickname(){
        ...
        userService.registerUser(userRegisterDto);
        User user = userRepository.findByUsername("유저5").get();
    ...
    void checkNoDuplicateNickname(){
        ...
        userService.registerUser(userRegisterDto);
        User user = userRepository.findByUsername("유저6").get();
    ...
    void printUserDetailAuthorities(){
        User user = userRepository.findByUsername("user12").get();
